...
public class PossibleEveningSession {
...
//		Index - 3, Value - 45
		...
		int[] progHrs = {45,5,60,45,30,30,45,60,60,45,30,30,60,30,30};
		...
		PossibleEveningSession test = new PossibleEveningSession();
		for (int i = 0; i < progHrs.length; i++) {
